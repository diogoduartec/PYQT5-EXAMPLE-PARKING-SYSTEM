...
def tbl_vehicle(connection):
    ...
    sql_command = "CREATE TABLE tbl_vehicle(vehicle_id INTEGER PRIMARY KEY AUTOINCREMENT, vehicle_plate VARCHAR(8), " \
                  "vehicle_model VARCHAR(25), vehicle_color VARCHAR(20), vehicle_arrival_time INTEGER, " \
                  "vehicle_departure_time INTEGER, vehicle_bill DOUBLE) "
